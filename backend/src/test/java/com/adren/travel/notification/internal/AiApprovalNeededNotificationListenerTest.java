 ...
 * have nothing to approve (PRD §11.2 principle 4).
 */
...
class AiApprovalNeededNotificationListenerTest {
    ...
    void dispatchesWhenTheDispositionIsSuggested() {
        AiApprovalNeededNotificationListener listener = new AiApprovalNeededNotificationListener(dispatcher);
        UUID consultantId = UUID.randomUUID();
        AiSuggestionGeneratedEvent event = new AiSuggestionGeneratedEvent(
            UUID.randomUUID(), UUID.randomUUID(), consultantId, "SUGGESTED");
